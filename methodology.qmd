...
As in the @clusters-plots, we see that the variability of the points is distributed mostly over the first component (X axis).
...
kap_2 = kap(dataset_strata, hc_group_2, pca_group_2)
kap_3 = kap(dataset_strata, hc_group_3, pca_group_3)
kap_4 = kap(dataset_strata, hc_group_4, pca_group_4)
```
...
```{r}
#| echo: false
# readr::write_csv(sampling_10, "data/processed/sample-10.csv")
# readr::write_csv(sampling_20, "data/processed/sample-20.csv")
```
