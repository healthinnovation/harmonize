      ...
      map <- map %>% 
        addPulseMarkers(
          ...
          popup = ~paste0(
            ...
            "- ⛈️Precipitation: ",round(innovalab$pr_mean,4),"<br>",
            "- 💧Runoff: ",round(innovalab$ro_mean,4),"<br>",
            "- ♒Soil mousture: ", round(innovalab$soil_mean,4),"<br>",
            "- 🌡️Maximum temperature: ",round(innovalab$tmax_mean,4),"<br>",
            "- 🧊Minimum temperature: ",round(innovalab$tmin_mean,4),"<br>",
            "- 💦Evapotranspiration: ", round(innovalab$tmin_mean,4),"<br>",
            "- ☁️Humidity: ", round(innovalab$humidity_mean,4),"<br>",
            "- 🌳🪓Deforestation: ", round(innovalab$def_mean,4),"<br>",
            "- 🛣️Global Superficie Human: ",round(innovalab$gsh_mean,4),"<br>",
            "- ✨Nigth lights: ", round(innovalab$ln_mean,4),"<br>",
            "- 🏙Population: ",round(innovalab$pop_mean,4) 
          ))
    }
