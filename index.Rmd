---
title: "Disease mapping on the Iquitos-Nauta road 🦟🛣️"
output:
  ...
  observe({
    ...
    if(comunidad == "QUISTOCOHA"){
      ...
      leafletProxy("map") %>%
        ...
        hideGroup(c("criadero","cobertura","focus-criadero","focus-cobertura"))
