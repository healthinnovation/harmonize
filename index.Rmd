...
<img src='https://www.cayetano.edu.pe/guia-postulante/imagenes/LogoCayetano.svg' width='40%'>
<br>
<img src='https://raw.githubusercontent.com/ambarja/sources-innovalab/2e1720a1edbf3cc0db56f1771e085c4b83955bef/logo.svg' width='40%'>
    ...
    bbox <- st_read("data/communities_hexagon.gpkg") %>% 
      ...
      mutate(name = str_to_upper(name),
         name = case_when(
           ...
           name == "UNIÓN PROGRESO" ~ "UNION PROGRESO",
           name == "PEÑA NEGRA" ~ "PENA NEGRA",
